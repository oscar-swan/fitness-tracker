...
**Live demo:** https://fitness-tracker-b6mc.onrender.com
...
- Have just one open database helper call when a series of functions are called instead of opening the database once per function
